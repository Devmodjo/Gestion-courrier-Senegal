...
public class DashboardController {
    ...
    @FXML
    private Label TotalEntrant;
    @FXML
    private Label TotalSortant;
    @FXML
    private Label TotalEnregistrer;
    
    @FXML
    protected Label spawnListCourrierOrdinaireEntrant;
	...
	public void showMaxCourrierentrant(){
		try
		{
			...
			this.TotalEntrant.setText(Integer.toString(maxNumberEntrant()));
	...
	public void showMaxCourrierSortant() {
		try 
		{
			...
			TotalSortant.setText(Integer.toString(maxNumberSortant()));
			TotalEnregistrer.setText(Integer.toString(maxNumberEntrant() + maxNumberSortant()));
